		    ...
		    <div id="home-section-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="Design/images/barbershop_1.jpg" alt="First slide">
                        <div class="carousel-caption d-md-block">
                            <h3>Get a Haircut and feel the Experience.</h3>
                            <p>
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/barbershop_2.jpg" alt="Second slide">
                        <div class="carousel-caption d-md-block">
                            <h3>Get a Hairstyle and look Beautiful.</h3>
                            <p>
                                Our salon is a place created pure refreshness.
                                <br>
                                premium quality, time and flawless look.
                            </p>
                        </div>
                    ...
                    <!-- THIRD SLIDE -->
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/barbershop_3.jpg" alt="Third slide">
                        <div class="carousel-caption d-md-block">
                            <h3>Get a Haircut and feel the Experience.</h3>
                            <p>
                                Our barbershop is the territory created purely for males who appreciate
